...
class Users:
    ...
    def load(self):
        self.dataframe = pd.read_csv('./embeddings/userEncodedEmbedded.csv', index_col=0, engine='python')
...
class Products:
    ...
    def load(self):
        self.dataframe = pd.read_csv('./embeddings/productEncodedEmbedded.csv', index_col=0, engine='python')
...
class DotProductsUser:
    ...
    def load(self):
        self.dataframe = pd.read_csv('./embeddings/dot_product_user.csv', index_col=0, engine='python')
